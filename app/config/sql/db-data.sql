...
(6, 'pcomment_removed', 'Your comment "%s" in <a href="/projects/{project_owner_name}/{project_id}">{project_name}</a> has been removed because multiple Scratch members considered it inappropriate for the Scratch community. Please read the <a  href="/terms">Community Guidelines</a> or contact us for more info. Thank you and Scratch on!\r\n<br/>\r\nThe Scratch Team has been informed of this and will decide to keep or lift the censorship', '0'),
(7, 'gcomment_removed', 'Your comment "%s" in <a href=''/galleries/view/{gallery_id}''>{gallery_name}</a> has been removed because multiple Scratch members considered it inappropriate for the Scratch community. Please read the <a  href="/terms">Community Guidelines</a> or contact us for more info. Thank you and Scratch on!\r\n<br/>\r\nThe Scratch Team has been informed of this and will decide to keep or lift the censorship', '0'),
(8, 'inappropriate_pcomment', 'Your comment "%s" in <a href="/projects/{project_owner_name}/{project_id}">{project_name}</a> was not posted because the system considered it inappropriate automatically. \r\n<br/>\r\nSometimes this automatic censorship is incorrect and we apologize if this is the case. We remind you to use appropriate language for all ages, please read the <a href="/terms">Community Guidelines</a>', '0'),
...
(12, 'inappropriate_gtitle', 'The title  of your gallery <a href="/galleries/view/{gallery_id}">{gallery_name}</a> is potentially using inappropriate language. We remind you to use appropriate language for all ages, please read the <a href="/terms">Community Guidelines</a>', '0'),
(13, 'inappropriate_ptitle', 'The title  of your project <a href="/projects/{to_user_name}/{project_id}">{project_name}</a> is potentially using inappropriate language. We remind you to use appropriate language for all ages, please read the <a href="/terms">Community Guidelines</a>', '0'),
(14, 'inappropriate_gdesc', 'The description  of your gallery <a href="/galleries/view/{gallery_id}">{gallery_name}</a> is potentially using inappropriate language. We remind you to use appropriate language for all ages, please read the <a href="/terms">Community Guidelines</a>', '0'),
(15, 'inappropriate_pdesc', 'The notes on your project <a href="/projects/{to_user_name}/{project_id}">{project_name}</a> is potentially using inappropriate language. We remind you to use appropriate language for all ages, please read the <a href="/terms">Community Guidelines</a>', '0'),
(16, 'inappropriate_gtag', 'Your tag "%s" in <a href=''/galleries/view/{gallery_id}''>{gallery_name}</a> was not posted because the system considered it inappropriate automatically.\r\n<br/>\r\nSometimes this automatic censorship is incorrect and we apologize if this is the case. We remind you to use appropriate language for all ages when tagging a project. Please read the <a href="/terms">Community Guidelines</a>', '0'),
...
(18, 'inappropriate_ptitle_upload', 'The title  of your project <a href="/projects/{to_user_name}/{project_id}">{project_name}</a> is potentially using inappropriate language. We remind you to use appropriate language for all ages, please read the <a href="/terms">Community Guidelines</a>', '0'),
(19, 'inappropriate_pdesc_upload', 'The notes on your project <a href="/projects/{to_user_name}/{project_id}">{project_name}</a> is potentially using inappropriate language. We remind you to use appropriate language for all ages, please read the <a href="/terms">Community Guidelines</a>', '0'),
