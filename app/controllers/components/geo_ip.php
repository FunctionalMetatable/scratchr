...
class GeoIpComponent extends Object {
	...
	*/
	...
	/*
	Returns region name based on IP
	@params:ip
	*/
	function getIpDetails($ip){
		...
		$temp['postal_code'] =  $record->postal_code;
		$temp['latitude'] = $record->latitude;
		$temp['longitude'] = $record->longitude;
		$temp['metro_code'] = $record->metro_code;
		$temp['area_code'] = $record->area_code;
		geoip_close($handle);
		return $temp;
	}
