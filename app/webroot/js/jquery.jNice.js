...
/*	var ButtonAdd = function(){
	...
	var SelectAdd = function(element, index){
		...
		$select.addClass('jNiceHidden').after('<div class="jNiceSelectWrapper"><div class="jNiceSelectLeft"></div><div><span class="jNiceSelectText"></span><span class="jNiceSelectOpen"></span></div><ul></ul></div>');
