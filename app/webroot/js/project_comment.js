...
function showReplyBox(comment_id, showReplies, toggle) {
	...
	var frame = document.getElementById('project_comment_reply_frame_' + comment_id);
	...
	var text_input = document.getElementById('project_comment_reply_input_' + comment_id);
