...
<td class='flagbox' id='f_<?php echo $flag['id'] ?>'>
    ...
    <a target='_blank' href='/projects/<?php echo $project['User']['urlname']; ?>/<?php echo $project['Project']['id'] ?>'>
        <?php echo $project['Project']['name'] ?></a> (<abbr title='<?php echo $abbrtitle; ?>'><?php echo $abbrcontent; ?></abbr>) <strong style='color:#F00'>community censored</strong> - flagged by multiple users.
