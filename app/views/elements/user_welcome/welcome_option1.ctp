...
<!-- Should match user_projects from here on out -->
		...
		<table border="0" cellpadding="10" align=left style="padding:0px 20px;">
			<tbody>
				<tr>
					<td align=left>
						<a href="http://scratch.mit.edu/projects/gobo/1040203"><img width="161" height="121" src="http://scratch.mit.edu/static/projects/gobo/1040203_sm.png" alt=""></a>
					</td>

				</tr>
				<tr>
					<td align=left>
						<a href="http://scratch.mit.edu/projects/gobo/1040203">Gobo's Welcome Project!</a>
					</td>
				</tr>
			</tbody>
		</table>
