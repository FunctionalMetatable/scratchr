...
<div class="container" id="loginForm">
  <form action="<?php echo $html->url('/users/send_request')?>" method="POST" accept-charset="UTF-8">
...
<!-- testing //-->	
	<div id="send_request">
		<div class="login_row">
			<?php echo $form->input('WhitelistedIpAddress.ipaddress',array('size'=>28,'value'=>$client_ip,'style'=>'font-size:14px'))?>	
		</div>
		<div class="login_row">
			<?php echo $form->input('WhitelistedIpAddress.contact_name',array('size'=>28))?>	
		</div>
		
		<div class="login_row">
		<?php echo $form->input('WhitelistedIpAddress.email',array('size'=>28))?>	
		</div>
		
		<div class="login_row">
		<?php echo $form->input('WhitelistedIpAddress.school_name',array('size'=>28))?>	
		</div>
		<div class="login_row">
		...
		<div class="login_row">
		<?php echo $form->input('WhitelistedIpAddress.no_of_student',array('size'=>28))?>	
		</div>
